...
static t_merror command_to_exec_cmd(t_command *const command, t_exec_command *exec_cmd)
{
	t_length	i;
	char	 	*tmp;
...
static t_merror convert_vect_commands(t_vector *const commands, t_vector *exec_cmds)
{
	t_length i;
